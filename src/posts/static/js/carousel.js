window.addEventListener("load", () => {
  ...
  $(document).on("click", ".carousel-item.active", function() {
    if (
      $(".carousel-item.active .carousel-item__image")[0].style.width == "60%"
    ) {
      $(".carousel-item.active .carousel-item__image").css(
        "background-position",
        "center"
      );
  ...
  function setSlide(prev, next) {
    ...
    $(".carousel-item")
      .eq(slide)
      .addClass("active");
    $("#background-number").html("Project n°" + parseInt(slide + 1));
