...
<div style="background-color:transparent;">
<div class="block-grid" style="Margin: 0 auto; min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #d9d9d9;">
<div style="border-collapse: collapse;display: table;width: 100%;background-color:#d9d9d9;">
<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px"><tr class="layout-full-width" style="background-color:#d9d9d9"><![endif]-->
<!--[if (mso)|(IE)]><td align="center" width="600" style="background-color:#d9d9d9;width:600px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 20px; padding-top:5px; padding-bottom:5px;"><![endif]-->
<div class="col num12" style="min-width: 320px; max-width: 600px; display: table-cell; vertical-align: top; width: 600px;">
<div style="width:100% !important;">
<!--[if (!mso)&(!IE)]><!-->
...
<p style="font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Hello <strong>{}</strong>, <br/></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 1.5; color:black; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">Thank you for your email. Here is a copy of the message you've sent us.</p>
<p style="font-size: 14px; line-height: 1.5; color:black; word-break: break-word; mso-line-height-alt: 21px; margin: 0;"><br/> message = {}</p>
<p style="font-size: 14px; line-height: 1.5; color:black; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">subject = {}<br/> urgency = {}<br/> pricerange = {}<br/><br/></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="color:black; font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">Thanks so much for contacting <a href="https://portfolio.pythonbots.site/">craft studios</a> ! </span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
